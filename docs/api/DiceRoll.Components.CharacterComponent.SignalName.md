# <a id="DiceRoll_Components_CharacterComponent_SignalName"></a> Class CharacterComponent.SignalName
...
```csharp
public class CharacterComponent.SignalName : Control.SignalName
```
