# <a id="DiceRoll_Components_CharacterRow_MethodName"></a> Class CharacterRow.MethodName
...
```csharp
public class CharacterRow.MethodName : HBoxContainer.MethodName
```
...
### <a id="DiceRoll_Components_CharacterRow_MethodName_FlipCharacters"></a> FlipCharacters

Cached name for the 'FlipCharacters' method.

```csharp
public static readonly StringName FlipCharacters
```
...
### <a id="DiceRoll_Components_CharacterRow_MethodName_LoadCharacters"></a> LoadCharacters

Cached name for the 'LoadCharacters' method.

```csharp
public static readonly StringName LoadCharacters
```
...
### <a id="DiceRoll_Components_CharacterRow_MethodName_OnDirectionSet"></a> OnDirectionSet

Cached name for the 'OnDirectionSet' method.

```csharp
public static readonly StringName OnDirectionSet
```
...
### <a id="DiceRoll_Components_CharacterRow_MethodName_OnGroupLabelSet"></a> OnGroupLabelSet

Cached name for the 'OnGroupLabelSet' method.

```csharp
public static readonly StringName OnGroupLabelSet
```
...
### <a id="DiceRoll_Components_CharacterRow_MethodName__Ready"></a> \_Ready
