# <a id="DiceRoll_Components_CharacterRow"></a> Class CharacterRow
...
```csharp
[Tool]
[ScriptPath("res://components/CharacterRow/CharacterRow.cs")]
public class CharacterRow : HBoxContainer, IDisposable
```
...
### <a id="DiceRoll_Components_CharacterRow_Container1Node"></a> Container1Node

```csharp
[Export(PropertyHint.None, "")]
public Control? Container1Node
```
...
### <a id="DiceRoll_Components_CharacterRow_Container2Node"></a> Container2Node

```csharp
[Export(PropertyHint.None, "")]
public Control? Container2Node
```
...
### <a id="DiceRoll_Components_CharacterRow_Container3Node"></a> Container3Node

```csharp
[Export(PropertyHint.None, "")]
public Control? Container3Node
```
...
### <a id="DiceRoll_Components_CharacterRow_GroupLabel"></a> GroupLabel
...
### <a id="DiceRoll_Components_CharacterRow_GroupNameRotationNode"></a> GroupNameRotationNode

```csharp
[Export(PropertyHint.None, "")]
public Control? GroupNameRotationNode
```
...
### <a id="DiceRoll_Components_CharacterRow_CharacterComponentScene"></a> CharacterComponentScene
...
### <a id="DiceRoll_Components_CharacterRow_CharacterStore"></a> CharacterStore
...
### <a id="DiceRoll_Components_CharacterRow_ForwardDirection"></a> ForwardDirection
...
### <a id="DiceRoll_Components_CharacterRow_IsEnemy"></a> IsEnemy
...
### <a id="DiceRoll_Components_CharacterRow_RowContainerNode"></a> RowContainerNode

```csharp
[ExportGroup("🔘 Nodes", "")]
[Export(PropertyHint.None, "")]
public HBoxContainer? RowContainerNode { get; set; }
```
...
### <a id="DiceRoll_Components_CharacterRow__Ready"></a> \_Ready\(\)
