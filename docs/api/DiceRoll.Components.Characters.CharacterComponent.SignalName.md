# <a id="DiceRoll_Components_Characters_CharacterComponent_SignalName"></a> Class CharacterComponent.SignalName
...
```csharp
public class CharacterComponent.SignalName : Node3D.SignalName
```
