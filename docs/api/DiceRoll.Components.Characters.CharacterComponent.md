# <a id="DiceRoll_Components_Characters_CharacterComponent"></a> Class CharacterComponent
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_InputAreaNode"></a> InputAreaNode
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_IsEnemy"></a> IsEnemy
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_IsSelected"></a> IsSelected
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_SelectorSpriteNode"></a> SelectorSpriteNode
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_GetGodotClassPropertyValue_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_godot_variant__"></a> GetGodotClassPropertyValue\(in godot\_string\_name, out godot\_variant\)
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_InvokeGodotClassMethod_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_NativeVariantPtrArgs_Godot_NativeInterop_godot_variant__"></a> InvokeGodotClassMethod\(in godot\_string\_name, NativeVariantPtrArgs, out godot\_variant\)
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_SaveGodotObjectData_Godot_Bridge_GodotSerializationInfo_"></a> SaveGodotObjectData\(GodotSerializationInfo\)
...
### <a id="DiceRoll_Components_Characters_CharacterComponent_SetGodotClassPropertyValue_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_godot_variant__"></a> SetGodotClassPropertyValue\(in godot\_string\_name, in godot\_variant\)
...
### <a id="DiceRoll_Components_Characters_CharacterComponent__Ready"></a> \_Ready\(\)
