# <a id="DiceRoll_Components_Characters_CharacterInspector_SignalName"></a> Class CharacterInspector.SignalName
...
```csharp
public class CharacterInspector.SignalName : HBoxContainer.SignalName
```
