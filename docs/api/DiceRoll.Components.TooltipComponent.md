# <a id="DiceRoll_Components_TooltipComponent"></a> Class TooltipComponent
...
### <a id="DiceRoll_Components_TooltipComponent_AdvancedDescriptionPath"></a> AdvancedDescriptionPath
...
### <a id="DiceRoll_Components_TooltipComponent_DescriptionPath"></a> DescriptionPath
...
### <a id="DiceRoll_Components_TooltipComponent_LorePath"></a> LorePath
...
### <a id="DiceRoll_Components_TooltipComponent_ProgressBarDuration"></a> ProgressBarDuration
...
### <a id="DiceRoll_Components_TooltipComponent_ProgressBarPath"></a> ProgressBarPath
...
### <a id="DiceRoll_Components_TooltipComponent_TagsPath"></a> TagsPath
...
### <a id="DiceRoll_Components_TooltipComponent_TextureIconPath"></a> TextureIconPath
...
### <a id="DiceRoll_Components_TooltipComponent_TitlePath"></a> TitlePath
...
### <a id="DiceRoll_Components_TooltipComponent_HideTooltip"></a> HideTooltip\(\)

```csharp
public void HideTooltip()
```

### <a id="DiceRoll_Components_TooltipComponent_Initialize"></a> Initialize\(\)

```csharp
public void Initialize()
```

### <a id="DiceRoll_Components_TooltipComponent_SetTooltipTexts_System_String_System_String_System_String_System_String_System_String_"></a> SetTooltipTexts\(string, string, string, string, string\)
...
### <a id="DiceRoll_Components_TooltipComponent_ShowTooltip_Godot_Vector2_"></a> ShowTooltip\(Vector2\)
...
### <a id="DiceRoll_Components_TooltipComponent__Ready"></a> \_Ready\(\)
