# <a id="DiceRoll_Components_TurnOrderComponent_MethodName"></a> Class TurnOrderComponent.MethodName
...
```csharp
public class TurnOrderComponent.MethodName : Control.MethodName
```
...
### <a id="DiceRoll_Components_TurnOrderComponent_MethodName_OnCharacterAttributeChanged"></a> OnCharacterAttributeChanged

Cached name for the 'OnCharacterAttributeChanged' method.

```csharp
public static readonly StringName OnCharacterAttributeChanged
```
...
### <a id="DiceRoll_Components_TurnOrderComponent_MethodName_OnPortraitTemplateChanged"></a> OnPortraitTemplateChanged

Cached name for the 'OnPortraitTemplateChanged' method.

```csharp
public static readonly StringName OnPortraitTemplateChanged
```
...
### <a id="DiceRoll_Components_TurnOrderComponent_MethodName_SetupPortraitInstance"></a> SetupPortraitInstance

Cached name for the 'SetupPortraitInstance' method.

```csharp
public static readonly StringName SetupPortraitInstance
```
...
### <a id="DiceRoll_Components_TurnOrderComponent_MethodName__Ready"></a> \_Ready
