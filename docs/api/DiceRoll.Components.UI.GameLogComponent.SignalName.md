# <a id="DiceRoll_Components_UI_GameLogComponent_SignalName"></a> Class GameLogComponent.SignalName
...
```csharp
public class GameLogComponent.SignalName : ScrollContainer.SignalName
```
