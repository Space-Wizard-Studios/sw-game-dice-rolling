# <a id="DiceRoll_Components_UI_GameLogComponent"></a> Class GameLogComponent
...
ScrollContainer.SetHScroll\(int\), 
ScrollContainer.GetHScroll\(\), 
ScrollContainer.SetVScroll\(int\), 
ScrollContainer.GetVScroll\(\), 
ScrollContainer.SetHorizontalCustomStep\(float\), 
ScrollContainer.GetHorizontalCustomStep\(\), 
ScrollContainer.SetVerticalCustomStep\(float\), 
ScrollContainer.GetVerticalCustomStep\(\), 
ScrollContainer.SetHorizontalScrollMode\(ScrollContainer.ScrollMode\), 
ScrollContainer.GetHorizontalScrollMode\(\), 
ScrollContainer.SetVerticalScrollMode\(ScrollContainer.ScrollMode\), 
ScrollContainer.GetVerticalScrollMode\(\), 
ScrollContainer.SetDeadzone\(int\), 
ScrollContainer.GetDeadzone\(\), 
ScrollContainer.SetFollowFocus\(bool\), 
ScrollContainer.IsFollowingFocus\(\), 
ScrollContainer.GetHScrollBar\(\), 
ScrollContainer.GetVScrollBar\(\), 
ScrollContainer.EnsureControlVisible\(Control\), 
ScrollContainer.SetDrawFocusBorder\(bool\), 
ScrollContainer.GetDrawFocusBorder\(\), 
ScrollContainer.EmitSignalScrollStarted\(\), 
ScrollContainer.EmitSignalScrollEnded\(\), 
ScrollContainer.InvokeGodotClassMethod\(in godot\_string\_name, NativeVariantPtrArgs, out godot\_variant\), 
ScrollContainer.HasGodotClassMethod\(in godot\_string\_name\), 
ScrollContainer.HasGodotClassSignal\(in godot\_string\_name\), 
ScrollContainer.FollowFocus, 
ScrollContainer.DrawFocusBorder, 
ScrollContainer.ScrollHorizontal, 
ScrollContainer.ScrollVertical, 
ScrollContainer.ScrollHorizontalCustomStep, 
ScrollContainer.ScrollVerticalCustomStep, 
ScrollContainer.HorizontalScrollMode, 
ScrollContainer.VerticalScrollMode, 
ScrollContainer.ScrollDeadzone, 
...
### <a id="DiceRoll_Components_UI_GameLogComponent__headingLabelTemplateNode"></a> \_headingLabelTemplateNode

```csharp
[Export(PropertyHint.None, "")]
public Label? _headingLabelTemplateNode
```
...
### <a id="DiceRoll_Components_UI_GameLogComponent__lineTemplateNode"></a> \_lineTemplateNode

```csharp
[Export(PropertyHint.None, "")]
public RichTextLabel? _lineTemplateNode
```
...
### <a id="DiceRoll_Components_UI_GameLogComponent__messageContainerNode"></a> \_messageContainerNode

```csharp
[Export(PropertyHint.None, "")]
public BoxContainer? _messageContainerNode
```
...
### <a id="DiceRoll_Components_UI_GameLogComponent__messageTemplateNode"></a> \_messageTemplateNode

```csharp
[Export(PropertyHint.None, "")]
public VBoxContainer? _messageTemplateNode
```
...
### <a id="DiceRoll_Components_UI_GameLogComponent__timestampLabelTemplateNode"></a> \_timestampLabelTemplateNode

```csharp
[Export(PropertyHint.None, "")]
public Label? _timestampLabelTemplateNode
```
...
### <a id="DiceRoll_Components_UI_GameLogComponent_InvokeGodotClassMethod_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_NativeVariantPtrArgs_Godot_NativeInterop_godot_variant__"></a> InvokeGodotClassMethod\(in godot\_string\_name, NativeVariantPtrArgs, out godot\_variant\)
...
### <a id="DiceRoll_Components_UI_GameLogComponent_SaveGodotObjectData_Godot_Bridge_GodotSerializationInfo_"></a> SaveGodotObjectData\(GodotSerializationInfo\)
...
### <a id="DiceRoll_Components_UI_GameLogComponent_SetGodotClassPropertyValue_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_godot_variant__"></a> SetGodotClassPropertyValue\(in godot\_string\_name, in godot\_variant\)
