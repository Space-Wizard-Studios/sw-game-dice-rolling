# <a id="DiceRoll_Components_UI_InventoryItemComponent_SignalName"></a> Class InventoryItemComponent.SignalName
...
```csharp
public class InventoryItemComponent.SignalName : Control.SignalName
```
