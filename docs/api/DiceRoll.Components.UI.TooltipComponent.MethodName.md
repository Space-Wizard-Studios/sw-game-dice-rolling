# <a id="DiceRoll_Components_UI_TooltipComponent_MethodName"></a> Class TooltipComponent.MethodName
...
```csharp
public class TooltipComponent.MethodName : Control.MethodName
```
...
### <a id="DiceRoll_Components_UI_TooltipComponent_MethodName_HideTooltip"></a> HideTooltip

Cached name for the 'HideTooltip' method.

```csharp
public static readonly StringName HideTooltip
```
...
### <a id="DiceRoll_Components_UI_TooltipComponent_MethodName_Initialize"></a> Initialize
...
### <a id="DiceRoll_Components_UI_TooltipComponent_MethodName_OnTooltipTimerTimeout"></a> OnTooltipTimerTimeout

Cached name for the 'OnTooltipTimerTimeout' method.

```csharp
public static readonly StringName OnTooltipTimerTimeout
```
...
### <a id="DiceRoll_Components_UI_TooltipComponent_MethodName_PositionTooltip"></a> PositionTooltip

Cached name for the 'PositionTooltip' method.

```csharp
public static readonly StringName PositionTooltip
```
...
### <a id="DiceRoll_Components_UI_TooltipComponent_MethodName_SetTooltipTexts"></a> SetTooltipTexts

Cached name for the 'SetTooltipTexts' method.

```csharp
public static readonly StringName SetTooltipTexts
```
...
### <a id="DiceRoll_Components_UI_TooltipComponent_MethodName_ShowTooltip"></a> ShowTooltip

Cached name for the 'ShowTooltip' method.

```csharp
public static readonly StringName ShowTooltip
```
...
### <a id="DiceRoll_Components_UI_TooltipComponent_MethodName__Ready"></a> \_Ready
