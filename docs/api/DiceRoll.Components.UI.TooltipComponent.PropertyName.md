# <a id="DiceRoll_Components_UI_TooltipComponent_PropertyName"></a> Class TooltipComponent.PropertyName
...
Cached name for the 'TagsPath' property.
...
Cached name for the '_textureIcon' field.
