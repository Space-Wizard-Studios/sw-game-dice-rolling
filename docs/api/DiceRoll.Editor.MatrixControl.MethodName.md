# <a id="DiceRoll_Editor_MatrixControl_MethodName"></a> Class MatrixControl.MethodName
...
```csharp
public class MatrixControl.MethodName : Control.MethodName
```
...
### <a id="DiceRoll_Editor_MatrixControl_MethodName_FlipHorizontally"></a> FlipHorizontally

Cached name for the 'FlipHorizontally' method.

```csharp
public static readonly StringName FlipHorizontally
```
...
### <a id="DiceRoll_Editor_MatrixControl_MethodName_UpdateDimensions"></a> UpdateDimensions

Cached name for the 'UpdateDimensions' method.

```csharp
public static readonly StringName UpdateDimensions
```
...
### <a id="DiceRoll_Editor_MatrixControl_MethodName_UpdateMinimumSize"></a> UpdateMinimumSize

Cached name for the 'UpdateMinimumSize' method.

```csharp
public static readonly StringName UpdateMinimumSize
```
...
### <a id="DiceRoll_Editor_MatrixControl_MethodName__Draw"></a> \_Draw
...
### <a id="DiceRoll_Editor_MatrixControl_MethodName__GuiInput"></a> \_GuiInput

Cached name for the '_GuiInput' method.

```csharp
public static readonly StringName _GuiInput
```
