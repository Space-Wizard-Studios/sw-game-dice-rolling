# <a id="DiceRoll_Events_EventBus_MethodName"></a> Class EventBus.MethodName
...
```csharp
public class EventBus.MethodName : Node.MethodName
```
...
### <a id="DiceRoll_Events_EventBus_MethodName_EmitAttributeChanged"></a> EmitAttributeChanged

Cached name for the 'EmitAttributeChanged' method.

```csharp
public static readonly StringName EmitAttributeChanged
```
...
### <a id="DiceRoll_Events_EventBus_MethodName_GetInstance"></a> GetInstance

Cached name for the 'GetInstance' method.

```csharp
public static readonly StringName GetInstance
```
...
### <a id="DiceRoll_Events_EventBus_MethodName_OnCharacterInspected"></a> OnCharacterInspected
...
### <a id="DiceRoll_Events_EventBus_MethodName__Ready"></a> \_Ready
