# <a id="DiceRoll_Managers_DungeonManager_MethodName"></a> Class DungeonManager.MethodName
...
```csharp
public class DungeonManager.MethodName : Node2D.MethodName
```
...
### <a id="DiceRoll_Managers_DungeonManager_MethodName__Ready"></a> \_Ready
