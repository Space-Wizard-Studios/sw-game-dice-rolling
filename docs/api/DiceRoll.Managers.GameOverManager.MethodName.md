# <a id="DiceRoll_Managers_GameOverManager_MethodName"></a> Class GameOverManager.MethodName
...
```csharp
public class GameOverManager.MethodName : Node2D.MethodName
```
...
### <a id="DiceRoll_Managers_GameOverManager_MethodName__Ready"></a> \_Ready
