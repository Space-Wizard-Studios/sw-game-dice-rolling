# <a id="DiceRoll_Managers_GameOverManager"></a> Class GameOverManager

Namespace: [DiceRoll.Managers](DiceRoll.Managers.md)  
Assembly: dice\-roll.dll  

```csharp
[ScriptPath("res://core/managers/menus/GameOverManager.cs")]
public class GameOverManager : Node2D, IDisposable
```
...
### <a id="DiceRoll_Managers_GameOverManager_GetGodotMethodList"></a> GetGodotMethodList\(\)
...
### <a id="DiceRoll_Managers_GameOverManager_HasGodotClassMethod_Godot_NativeInterop_godot_string_name__"></a> HasGodotClassMethod\(in godot\_string\_name\)
...
### <a id="DiceRoll_Managers_GameOverManager_InvokeGodotClassMethod_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_NativeVariantPtrArgs_Godot_NativeInterop_godot_variant__"></a> InvokeGodotClassMethod\(in godot\_string\_name, NativeVariantPtrArgs, out godot\_variant\)
...
### <a id="DiceRoll_Managers_GameOverManager_RestoreGodotObjectData_Godot_Bridge_GodotSerializationInfo_"></a> RestoreGodotObjectData\(GodotSerializationInfo\)
...
### <a id="DiceRoll_Managers_GameOverManager_SaveGodotObjectData_Godot_Bridge_GodotSerializationInfo_"></a> SaveGodotObjectData\(GodotSerializationInfo\)
...
### <a id="DiceRoll_Managers_GameOverManager__Ready"></a> \_Ready\(\)
