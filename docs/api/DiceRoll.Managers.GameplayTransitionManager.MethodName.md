# <a id="DiceRoll_Managers_GameplayTransitionManager_MethodName"></a> Class GameplayTransitionManager.MethodName
...
```csharp
public class GameplayTransitionManager.MethodName : Node.MethodName
```
...
### <a id="DiceRoll_Managers_GameplayTransitionManager_MethodName_TransitionTo"></a> TransitionTo
