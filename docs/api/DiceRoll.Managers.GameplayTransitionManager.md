...
### <a id="DiceRoll_Managers_GameplayTransitionManager_GetGodotMethodList"></a> GetGodotMethodList\(\)
...
### <a id="DiceRoll_Managers_GameplayTransitionManager_GetGodotPropertyList"></a> GetGodotPropertyList\(\)
