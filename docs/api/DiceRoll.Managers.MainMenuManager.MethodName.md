# <a id="DiceRoll_Managers_MainMenuManager_MethodName"></a> Class MainMenuManager.MethodName
...
```csharp
public class MainMenuManager.MethodName : Node2D.MethodName
```
...
### <a id="DiceRoll_Managers_MainMenuManager_MethodName__Ready"></a> \_Ready
