# <a id="DiceRoll_Managers_PlaygroundTransitionManager_MethodName"></a> Class PlaygroundTransitionManager.MethodName
...
```csharp
public class PlaygroundTransitionManager.MethodName : Node.MethodName
```
...
### <a id="DiceRoll_Managers_PlaygroundTransitionManager_MethodName_TransitionTo"></a> TransitionTo
