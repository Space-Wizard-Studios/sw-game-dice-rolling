# <a id="DiceRoll_Models_Character_SignalName"></a> Class Character.SignalName
...
```csharp
public class Character.SignalName : Resource.SignalName
```
...
### <a id="DiceRoll_Models_Character_SignalName_AttributeChanged"></a> AttributeChanged
