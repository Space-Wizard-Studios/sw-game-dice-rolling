# <a id="DiceRoll_Models_CharacterActions_ActionType"></a> Class ActionType
...
[Tool]
[GlobalClass]
[ScriptPath("res://models/CharacterActions/ActionType.cs")]
...
### <a id="DiceRoll_Models_CharacterActions_ActionType__ctor"></a> ActionType\(\)

```csharp
public ActionType()
```

### <a id="DiceRoll_Models_CharacterActions_ActionType__ctor_System_String_System_String_Godot_Texture2D_"></a> ActionType\(string, string, Texture2D\)
...
### <a id="DiceRoll_Models_CharacterActions_ActionType_Description"></a> Description
...
### <a id="DiceRoll_Models_CharacterActions_ActionType_Icon"></a> Icon
...
### <a id="DiceRoll_Models_CharacterActions_ActionType_Name"></a> Name
