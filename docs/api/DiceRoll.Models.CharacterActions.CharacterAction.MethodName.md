# <a id="DiceRoll_Models_CharacterActions_CharacterAction_MethodName"></a> Class CharacterAction.MethodName
...
```csharp
public class CharacterAction.MethodName : Resource.MethodName
```
