# <a id="DiceRoll_Models_CharacterActions_CharacterAction_SignalName"></a> Class CharacterAction.SignalName
...
```csharp
public class CharacterAction.SignalName : Resource.SignalName
```
