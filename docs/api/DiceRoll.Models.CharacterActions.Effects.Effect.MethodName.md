# <a id="DiceRoll_Models_CharacterActions_Effects_Effect_MethodName"></a> Class Effect.MethodName
...
```csharp
public class Effect.MethodName : Resource.MethodName
```
...
### <a id="DiceRoll_Models_CharacterActions_Effects_Effect_MethodName__ValidateProperty"></a> \_ValidateProperty
