# <a id="DiceRoll_Models_CharacterActions_Effects_Effect"></a> Class Effect
...
```csharp
[Tool]
[ScriptPath("res://models/CharacterActions/Effect.cs")]
public abstract class Effect : Resource, IDisposable
```
...
### <a id="DiceRoll_Models_CharacterActions_Effects_Effect_NumberQuantity"></a> NumberQuantity
...
### <a id="DiceRoll_Models_CharacterActions_Effects_Effect_QuantityType"></a> QuantityType
...
### <a id="DiceRoll_Models_CharacterActions_Effects_Effect_TargetType"></a> TargetType
...
### <a id="DiceRoll_Models_CharacterActions_Effects_Effect_Apply_DiceRoll_Models_CharacterActions_IActionContext_"></a> Apply\(IActionContext\)
...
### <a id="DiceRoll_Models_CharacterActions_Effects_Effect__ValidateProperty_Godot_Collections_Dictionary_"></a> \_ValidateProperty\(Dictionary\)
