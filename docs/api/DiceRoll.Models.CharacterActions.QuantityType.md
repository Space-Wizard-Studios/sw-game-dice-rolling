# <a id="DiceRoll_Models_CharacterActions_QuantityType"></a> Class QuantityType
...
[Tool]
[GlobalClass]
[ScriptPath("res://models/CharacterActions/QuantityType.cs")]
public class QuantityType : Resource, IDisposable
```
...
### <a id="DiceRoll_Models_CharacterActions_QuantityType__ctor"></a> QuantityType\(\)

```csharp
public QuantityType()
```

### <a id="DiceRoll_Models_CharacterActions_QuantityType__ctor_System_String_"></a> QuantityType\(string\)
...
### <a id="DiceRoll_Models_CharacterActions_QuantityType_Name"></a> Name
