# <a id="DiceRoll_Models_CharacterActions_TargetType_PropertyName"></a> Class TargetType.PropertyName
...
```csharp
public class TargetType.PropertyName : Resource.PropertyName
```
...
### <a id="DiceRoll_Models_CharacterActions_TargetType_PropertyName_Name"></a> Name
