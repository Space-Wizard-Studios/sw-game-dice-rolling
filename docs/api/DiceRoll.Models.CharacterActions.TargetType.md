# <a id="DiceRoll_Models_CharacterActions_TargetType"></a> Class TargetType
...
[Tool]
[GlobalClass]
[ScriptPath("res://models/CharacterActions/TargetType.cs")]
public class TargetType : Resource, IDisposable
```
...
### <a id="DiceRoll_Models_CharacterActions_TargetType__ctor"></a> TargetType\(\)

```csharp
public TargetType()
```

### <a id="DiceRoll_Models_CharacterActions_TargetType__ctor_System_String_"></a> TargetType\(string\)
...
### <a id="DiceRoll_Models_CharacterActions_TargetType_Name"></a> Name
