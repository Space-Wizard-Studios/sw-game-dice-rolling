# <a id="DiceRoll_Models_CharacterAttribute_MethodName"></a> Class CharacterAttribute.MethodName
...
```csharp
public class CharacterAttribute.MethodName : Resource.MethodName
```
...
### <a id="DiceRoll_Models_CharacterAttribute_MethodName__ValidateProperty"></a> \_ValidateProperty
