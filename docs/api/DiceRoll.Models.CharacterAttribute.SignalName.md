# <a id="DiceRoll_Models_CharacterAttribute_SignalName"></a> Class CharacterAttribute.SignalName
...
```csharp
public class CharacterAttribute.SignalName : Resource.SignalName
```
