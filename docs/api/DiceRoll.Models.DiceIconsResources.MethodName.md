# <a id="DiceRoll_Models_DiceIconsResources_MethodName"></a> Class DiceIconsResources.MethodName
...
```csharp
public class DiceIconsResources.MethodName : Resource.MethodName
```
...
### <a id="DiceRoll_Models_DiceIconsResources_MethodName_GetIconForSides"></a> GetIconForSides

Cached name for the 'GetIconForSides' method.

```csharp
public static readonly StringName GetIconForSides
```
