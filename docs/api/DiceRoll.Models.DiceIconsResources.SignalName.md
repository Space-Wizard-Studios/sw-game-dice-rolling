# <a id="DiceRoll_Models_DiceIconsResources_SignalName"></a> Class DiceIconsResources.SignalName
...
```csharp
public class DiceIconsResources.SignalName : Resource.SignalName
```
