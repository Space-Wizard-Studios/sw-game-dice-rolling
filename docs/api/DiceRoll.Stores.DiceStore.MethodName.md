# <a id="DiceRoll_Stores_DiceStore_MethodName"></a> Class DiceStore.MethodName
...
```csharp
public class DiceStore.MethodName : Node.MethodName
```
...
### <a id="DiceRoll_Stores_DiceStore_MethodName_RemoveDice"></a> RemoveDice

Cached name for the 'RemoveDice' method.

```csharp
public static readonly StringName RemoveDice
```
...
### <a id="DiceRoll_Stores_DiceStore_MethodName_UpdateDiceLocation"></a> UpdateDiceLocation

Cached name for the 'UpdateDiceLocation' method.

```csharp
public static readonly StringName UpdateDiceLocation
```
...
### <a id="DiceRoll_Stores_DiceStore_MethodName_UpdateDiceName"></a> UpdateDiceName

Cached name for the 'UpdateDiceName' method.

```csharp
public static readonly StringName UpdateDiceName
```
