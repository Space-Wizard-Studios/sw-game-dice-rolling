...
### <a id="DiceRoll_UI_ArcDrawer_MethodName_SetSelectedEnemy"></a> SetSelectedEnemy

Cached name for the 'SetSelectedEnemy' method.

```csharp
public static readonly StringName SetSelectedEnemy
```
...
### <a id="DiceRoll_UI_ArcDrawer_MethodName__Process"></a> \_Process
