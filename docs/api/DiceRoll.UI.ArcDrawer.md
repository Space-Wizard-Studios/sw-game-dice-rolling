...
### <a id="DiceRoll_UI_ArcDrawer_SetSelectedCharacter_DiceRoll_Components_CharacterComponent_"></a> SetSelectedCharacter\(CharacterComponent\)
...
### <a id="DiceRoll_UI_ArcDrawer_SetSelectedEnemy_DiceRoll_Components_CharacterComponent_"></a> SetSelectedEnemy\(CharacterComponent\)
...
`enemy` [CharacterComponent](DiceRoll.Components.CharacterComponent.md)

### <a id="DiceRoll_UI_ArcDrawer__Process_System_Double_"></a> \_Process\(double\)
