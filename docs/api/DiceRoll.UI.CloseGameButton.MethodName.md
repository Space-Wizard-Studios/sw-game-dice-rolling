# <a id="DiceRoll_UI_CloseGameButton_MethodName"></a> Class CloseGameButton.MethodName
...
```csharp
public class CloseGameButton.MethodName : Button.MethodName
```
...
### <a id="DiceRoll_UI_CloseGameButton_MethodName_OnButtonPressed"></a> OnButtonPressed
...
### <a id="DiceRoll_UI_CloseGameButton_MethodName__Ready"></a> \_Ready
