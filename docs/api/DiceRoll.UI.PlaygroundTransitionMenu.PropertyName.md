# <a id="DiceRoll_UI_PlaygroundTransitionMenu_PropertyName"></a> Class PlaygroundTransitionMenu.PropertyName
...
```csharp
public class PlaygroundTransitionMenu.PropertyName : MenuButton.PropertyName
```
...
MenuButton.PropertyName.SwitchOnHover, 
MenuButton.PropertyName.ItemCount, 
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_PropertyName__playgroundTransitionManager"></a> \_playgroundTransitionManager

Cached name for the '_playgroundTransitionManager' field.

```csharp
public static readonly StringName _playgroundTransitionManager
```
