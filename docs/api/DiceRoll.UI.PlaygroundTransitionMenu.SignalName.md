# <a id="DiceRoll_UI_PlaygroundTransitionMenu_SignalName"></a> Class PlaygroundTransitionMenu.SignalName
...
```csharp
public class PlaygroundTransitionMenu.SignalName : MenuButton.SignalName
```
...
MenuButton.SignalName.AboutToPopup, 
