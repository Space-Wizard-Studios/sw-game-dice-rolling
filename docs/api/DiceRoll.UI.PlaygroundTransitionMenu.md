# <a id="DiceRoll_UI_PlaygroundTransitionMenu"></a> Class PlaygroundTransitionMenu
...
```csharp
[Tool]
[ScriptPath("res://core/ui/PlaygroundTransitionMenu.cs")]
public class PlaygroundTransitionMenu : MenuButton, IDisposable
```
...
MenuButton.SetSwitchOnHover\(bool\), 
MenuButton.IsSwitchOnHover\(\), 
MenuButton.SetDisableShortcuts\(bool\), 
MenuButton.SetItemCount\(int\), 
MenuButton.GetItemCount\(\), 
MenuButton.EmitSignalAboutToPopup\(\), 
MenuButton.InvokeGodotClassMethod\(in godot\_string\_name, NativeVariantPtrArgs, out godot\_variant\), 
MenuButton.HasGodotClassMethod\(in godot\_string\_name\), 
MenuButton.HasGodotClassSignal\(in godot\_string\_name\), 
MenuButton.SwitchOnHover, 
MenuButton.ItemCount, 
MenuButton.AboutToPopup, 
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu__playgroundTransitionManager"></a> \_playgroundTransitionManager
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_GetGodotClassPropertyValue_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_godot_variant__"></a> GetGodotClassPropertyValue\(in godot\_string\_name, out godot\_variant\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_GetGodotMethodList"></a> GetGodotMethodList\(\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_GetGodotPropertyList"></a> GetGodotPropertyList\(\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_HasGodotClassMethod_Godot_NativeInterop_godot_string_name__"></a> HasGodotClassMethod\(in godot\_string\_name\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_InvokeGodotClassMethod_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_NativeVariantPtrArgs_Godot_NativeInterop_godot_variant__"></a> InvokeGodotClassMethod\(in godot\_string\_name, NativeVariantPtrArgs, out godot\_variant\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_OnItemPressed_System_Int32_"></a> OnItemPressed\(int\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_RestoreGodotObjectData_Godot_Bridge_GodotSerializationInfo_"></a> RestoreGodotObjectData\(GodotSerializationInfo\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_SaveGodotObjectData_Godot_Bridge_GodotSerializationInfo_"></a> SaveGodotObjectData\(GodotSerializationInfo\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu_SetGodotClassPropertyValue_Godot_NativeInterop_godot_string_name__Godot_NativeInterop_godot_variant__"></a> SetGodotClassPropertyValue\(in godot\_string\_name, in godot\_variant\)
...
### <a id="DiceRoll_UI_PlaygroundTransitionMenu__Ready"></a> \_Ready\(\)
