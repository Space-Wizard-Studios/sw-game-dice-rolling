# <a id="DiceRoll_UI_SceneTransitionButton_MethodName"></a> Class SceneTransitionButton.MethodName
...
```csharp
public class SceneTransitionButton.MethodName : Button.MethodName
```
...
BaseButton.MethodName.SetShortcutInTooltip, 
...
### <a id="DiceRoll_UI_SceneTransitionButton_MethodName_OnButtonPressed"></a> OnButtonPressed

Cached name for the 'OnButtonPressed' method.

```csharp
public static readonly StringName OnButtonPressed
```
...
### <a id="DiceRoll_UI_SceneTransitionButton_MethodName__Ready"></a> \_Ready
...
### <a id="DiceRoll_UI_SceneTransitionButton_MethodName__ValidateProperty"></a> \_ValidateProperty
