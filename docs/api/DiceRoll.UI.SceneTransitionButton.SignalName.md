# <a id="DiceRoll_UI_SceneTransitionButton_SignalName"></a> Class SceneTransitionButton.SignalName
...
```csharp
public class SceneTransitionButton.SignalName : Button.SignalName
```
