# <a id="DiceRolling_Battle_BattleManager"></a> Class BattleManager

Namespace: [DiceRolling.Battle](DiceRolling.Battle.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://features/Battle/BattleManager.cs")]
...
### <a id="DiceRolling_Battle_BattleManager__Ready"></a> \_Ready\(\)
