# <a id="DiceRolling_Characters_CharacterAction"></a> Class CharacterAction
...
[Tool]
[GlobalClass]
[ScriptPath("res://features/Character/CharacterAction.cs")]
...
### <a id="DiceRolling_Characters_CharacterAction__ctor"></a> CharacterAction\(\)

```csharp
public CharacterAction()
```

### <a id="DiceRolling_Characters_CharacterAction__ctor_DiceRolling_Roles_RoleAction_"></a> CharacterAction\(RoleAction\)
...
`roleAction` [RoleAction](DiceRolling.Roles.RoleAction.md)

## Properties

### <a id="DiceRolling_Characters_CharacterAction_Description"></a> Description
...
### <a id="DiceRolling_Characters_CharacterAction_Effects"></a> Effects
...
### <a id="DiceRolling_Characters_CharacterAction_Name"></a> Name
...
### <a id="DiceRolling_Characters_CharacterAction_Resolve_DiceRolling_Actions_IActionContext_"></a> Resolve\(IActionContext\)
