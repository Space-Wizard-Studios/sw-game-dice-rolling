# <a id="DiceRolling_Characters_CharacterAttribute"></a> Class CharacterAttribute
...
[Tool]
[GlobalClass]
[ScriptPath("res://features/Character/CharacterAttribute.cs")]
...
### <a id="DiceRolling_Characters_CharacterAttribute__ctor"></a> CharacterAttribute\(\)

```csharp
public CharacterAttribute()
```

### <a id="DiceRolling_Characters_CharacterAttribute__ctor_DiceRolling_Roles_RoleAttribute_"></a> CharacterAttribute\(RoleAttribute\)
...
`roleAttribute` [RoleAttribute](DiceRolling.Roles.RoleAttribute.md)

## Properties

### <a id="DiceRolling_Characters_CharacterAttribute_BaseValue"></a> BaseValue
...
### <a id="DiceRolling_Characters_CharacterAttribute_CurrentValue"></a> CurrentValue
...
### <a id="DiceRolling_Characters_CharacterAttribute_MaxValue"></a> MaxValue
...
### <a id="DiceRolling_Characters_CharacterAttribute_Type"></a> Type
...
### <a id="DiceRolling_Characters_CharacterAttribute__ValidateProperty_Godot_Collections_Dictionary_"></a> \_ValidateProperty\(Dictionary\)
