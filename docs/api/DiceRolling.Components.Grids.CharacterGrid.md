# <a id="DiceRolling_Components_Grids_CharacterGrid"></a> Class CharacterGrid
...
### <a id="DiceRolling_Components_Grids_CharacterGrid_GridConfigurations"></a> GridConfigurations

```csharp
[Export(PropertyHint.None, "")]
public GridType[] GridConfigurations
```
...
### <a id="DiceRolling_Components_Grids_CharacterGrid_ArrowMesh"></a> ArrowMesh

```csharp
[Export(PropertyHint.None, "")]
public PackedScene? ArrowMesh { get; set; }
```
...
### <a id="DiceRolling_Components_Grids_CharacterGrid_CellPadding"></a> CellPadding
...
### <a id="DiceRolling_Components_Grids_CharacterGrid_CharacterComponentScene"></a> CharacterComponentScene
...
### <a id="DiceRolling_Components_Grids_CharacterGrid__ExitTree"></a> \_ExitTree\(\)
...
### <a id="DiceRolling_Components_Grids_CharacterGrid__Ready"></a> \_Ready\(\)
