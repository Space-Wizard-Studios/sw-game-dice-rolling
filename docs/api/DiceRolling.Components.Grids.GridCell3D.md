# <a id="DiceRolling_Components_Grids_GridCell3D"></a> Class GridCell3D
...
### <a id="DiceRolling_Components_Grids_GridCell3D__ctor"></a> GridCell3D\(\)

```csharp
public GridCell3D()
```

### <a id="DiceRolling_Components_Grids_GridCell3D__ctor_Godot_Vector3_System_String_"></a> GridCell3D\(Vector3, string\)
...
### <a id="DiceRolling_Components_Grids_GridCell3D_CellLabel"></a> CellLabel
...
### <a id="DiceRolling_Components_Grids_GridCell3D_CellMarker"></a> CellMarker
...
### <a id="DiceRolling_Components_Grids_GridCell3D_Character"></a> Character
...
### <a id="DiceRolling_Components_Grids_GridCell3D_SetCharacter_DiceRolling_Components_Characters_CharacterComponent_"></a> SetCharacter\(CharacterComponent\)
