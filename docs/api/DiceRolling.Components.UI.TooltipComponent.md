# <a id="DiceRolling_Components_UI_TooltipComponent"></a> Class TooltipComponent
...
### <a id="DiceRolling_Components_UI_TooltipComponent_AdvancedDescriptionPath"></a> AdvancedDescriptionPath
...
### <a id="DiceRolling_Components_UI_TooltipComponent_DescriptionPath"></a> DescriptionPath
...
### <a id="DiceRolling_Components_UI_TooltipComponent_LorePath"></a> LorePath
...
### <a id="DiceRolling_Components_UI_TooltipComponent_ProgressBarDuration"></a> ProgressBarDuration
...
### <a id="DiceRolling_Components_UI_TooltipComponent_ProgressBarPath"></a> ProgressBarPath
...
### <a id="DiceRolling_Components_UI_TooltipComponent_TagsPath"></a> TagsPath
...
### <a id="DiceRolling_Components_UI_TooltipComponent_TextureIconPath"></a> TextureIconPath
...
### <a id="DiceRolling_Components_UI_TooltipComponent_TitlePath"></a> TitlePath
...
### <a id="DiceRolling_Components_UI_TooltipComponent_HideTooltip"></a> HideTooltip\(\)

```csharp
public void HideTooltip()
```

### <a id="DiceRolling_Components_UI_TooltipComponent_Initialize"></a> Initialize\(\)

```csharp
public void Initialize()
```

### <a id="DiceRolling_Components_UI_TooltipComponent_SetTooltipTexts_System_String_System_String_System_String_System_String_System_String_"></a> SetTooltipTexts\(string, string, string, string, string\)
...
### <a id="DiceRolling_Components_UI_TooltipComponent_ShowTooltip_Godot_Vector2_"></a> ShowTooltip\(Vector2\)
...
### <a id="DiceRolling_Components_UI_TooltipComponent__Ready"></a> \_Ready\(\)
