# <a id="DiceRolling_Dice_DiceEnergyStore"></a> Class DiceEnergyStore
...
[Tool]
[GlobalClass]
[ScriptPath("res://features/Dice/DiceEnergyStore.cs")]
public class DiceEnergyStore : Resource, IDisposable
```
...
### <a id="DiceRolling_Dice_DiceEnergyStore__ctor"></a> DiceEnergyStore\(\)
...
### <a id="DiceRolling_Dice_DiceEnergyStore_Energy"></a> Energy

```csharp
[Export(PropertyHint.None, "")]
public Array<DiceEnergy> Energy { get; set; }
```
