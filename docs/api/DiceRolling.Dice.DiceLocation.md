# <a id="DiceRolling_Dice_DiceLocation"></a> Class DiceLocation

Namespace: [DiceRolling.Dice](DiceRolling.Dice.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://features/Dice/DiceLocation.cs")]
...
### <a id="DiceRolling_Dice_DiceLocation__ctor_DiceRolling_Dice_DiceLocationCategory_System_String_"></a> DiceLocation\(DiceLocationCategory, string?\)
...
### <a id="DiceRolling_Dice_DiceLocation_CharacterId"></a> CharacterId
...
### <a id="DiceRolling_Dice_DiceLocation_LocationCategory"></a> LocationCategory
