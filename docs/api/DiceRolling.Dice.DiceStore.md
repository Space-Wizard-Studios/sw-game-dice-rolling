# <a id="DiceRolling_Dice_DiceStore"></a> Class DiceStore
...
### <a id="DiceRolling_Dice_DiceStore_DiceSet"></a> DiceSet

```csharp
public List<DiceType> DiceSet { get; }
```

#### Property Value

 [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[DiceType](DiceRolling.Dice.DiceType.md)\>

### <a id="DiceRolling_Dice_DiceStore_Instance"></a> Instance
...
### <a id="DiceRolling_Dice_DiceStore_AddDice_DiceRolling_Dice_DiceType_"></a> AddDice\(DiceType\)
...
`dice` [DiceType](DiceRolling.Dice.DiceType.md)

### <a id="DiceRolling_Dice_DiceStore_GetDiceByID_System_String_"></a> GetDiceByID\(string\)
...
### <a id="DiceRolling_Dice_DiceStore_RemoveDice_System_String_"></a> RemoveDice\(string\)
...
### <a id="DiceRolling_Dice_DiceStore_UpdateDiceByID_System_String_System_Action_DiceRolling_Dice_DiceType__"></a> UpdateDiceByID\(string, Action<DiceType\>\)
...
`updateFn` [Action](https://learn.microsoft.com/dotnet/api/system.action\-1)<[DiceType](DiceRolling.Dice.DiceType.md)\>

### <a id="DiceRolling_Dice_DiceStore_UpdateDiceLocation_System_String_DiceRolling_Dice_DiceLocation_"></a> UpdateDiceLocation\(string, DiceLocation\)
...
### <a id="DiceRolling_Dice_DiceStore_UpdateDiceName_System_String_System_String_"></a> UpdateDiceName\(string, string\)
