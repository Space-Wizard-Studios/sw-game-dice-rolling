# <a id="DiceRolling_Dungeon_DungeonManager"></a> Class DungeonManager

Namespace: [DiceRolling.Dungeon](DiceRolling.Dungeon.md)  
...
### <a id="DiceRolling_Dungeon_DungeonManager__Ready"></a> \_Ready\(\)
