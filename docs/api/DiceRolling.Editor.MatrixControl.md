# <a id="DiceRolling_Editor_MatrixControl"></a> Class MatrixControl
...
### <a id="DiceRolling_Editor_MatrixControl__ctor"></a> MatrixControl\(\)
...
### <a id="DiceRolling_Editor_MatrixControl_TargetConfiguration"></a> TargetConfiguration
...
### <a id="DiceRolling_Editor_MatrixControl_ClearGrids"></a> ClearGrids\(\)

```csharp
public void ClearGrids()
```

### <a id="DiceRolling_Editor_MatrixControl_FlipHorizontally_System_Boolean_"></a> FlipHorizontally\(bool\)
...
### <a id="DiceRolling_Editor_MatrixControl__Draw"></a> \_Draw\(\)
...
### <a id="DiceRolling_Editor_MatrixControl__GuiInput_Godot_InputEvent_"></a> \_GuiInput\(InputEvent\)
