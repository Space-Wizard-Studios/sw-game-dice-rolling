# <a id="DiceRolling_Editor_TargetBoardEditorPlugin"></a> Class TargetBoardEditorPlugin
...
```csharp
[Tool]
[ScriptPath("res://addons/@spacewiz/TargetBoardEditorPlugin/TargetBoardEditorPlugin.cs")]
public class TargetBoardEditorPlugin : EditorPlugin, IDisposable
```
...
### <a id="DiceRolling_Editor_TargetBoardEditorPlugin__EnterTree"></a> \_EnterTree\(\)
...
### <a id="DiceRolling_Editor_TargetBoardEditorPlugin__ExitTree"></a> \_ExitTree\(\)
