# <a id="DiceRolling_Effects_DamageEffect"></a> Class DamageEffect

Namespace: [DiceRolling.Effects](DiceRolling.Effects.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://features/Effect/DamageEffect.cs")]
...
[EffectType.Apply\(IActionContext\)](DiceRolling.Effects.EffectType.md\#DiceRolling\_Effects\_EffectType\_Apply\_DiceRolling\_Actions\_IActionContext\_), 
Resource.\_GetRid\(\), 
...
### <a id="DiceRolling_Effects_DamageEffect__ctor"></a> DamageEffect\(\)
...
### <a id="DiceRolling_Effects_DamageEffect_Apply_DiceRolling_Actions_IActionContext_"></a> Apply\(IActionContext\)
