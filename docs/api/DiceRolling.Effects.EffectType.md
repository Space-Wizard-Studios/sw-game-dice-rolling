# <a id="DiceRolling_Effects_EffectType"></a> Class EffectType
...
```csharp
[Tool]
[ScriptPath("res://features/Effect/EffectType.cs")]
...
### <a id="DiceRolling_Effects_EffectType_Apply_DiceRolling_Actions_IActionContext_"></a> Apply\(IActionContext\)
