# <a id="DiceRolling_Helpers_Arc3DRenderer"></a> Class Arc3DRenderer
...
### <a id="DiceRolling_Helpers_Arc3DRenderer_CubeSize"></a> CubeSize
...
### <a id="DiceRolling_Helpers_Arc3DRenderer_PointA"></a> PointA
...
### <a id="DiceRolling_Helpers_Arc3DRenderer_PointB"></a> PointB
...
### <a id="DiceRolling_Helpers_Arc3DRenderer_PointC"></a> PointC
...
### <a id="DiceRolling_Helpers_Arc3DRenderer_Spacing"></a> Spacing
...
### <a id="DiceRolling_Helpers_Arc3DRenderer_GeneratePath"></a> GeneratePath\(\)
...
### <a id="DiceRolling_Helpers_Arc3DRenderer__Ready"></a> \_Ready\(\)
