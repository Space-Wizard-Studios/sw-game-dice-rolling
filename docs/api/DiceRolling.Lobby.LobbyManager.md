# <a id="DiceRolling_Lobby_LobbyManager"></a> Class LobbyManager

Namespace: [DiceRolling.Lobby](DiceRolling.Lobby.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://features/Lobby/LobbyManager.cs")]
...
### <a id="DiceRolling_Lobby_LobbyManager__Ready"></a> \_Ready\(\)
