# <a id="DiceRolling_Managers_BattleManager"></a> Class BattleManager
...
Node ← 
Node3D ← 
[BattleManager](DiceRolling.Managers.BattleManager.md)
...
### <a id="DiceRolling_Managers_BattleManager__Ready"></a> \_Ready\(\)
