# <a id="DiceRolling_Managers_GameOverManager"></a> Class GameOverManager
...
CanvasItem ← 
Node2D ← 
[GameOverManager](DiceRolling.Managers.GameOverManager.md)
...
### <a id="DiceRolling_Managers_GameOverManager__Ready"></a> \_Ready\(\)
