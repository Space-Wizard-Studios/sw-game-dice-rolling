# <a id="DiceRolling_Managers_GameplayTransitionManager"></a> Class GameplayTransitionManager
...
GodotObject ← 
Node ← 
[GameplayTransitionManager](DiceRolling.Managers.GameplayTransitionManager.md)
...
### <a id="DiceRolling_Managers_GameplayTransitionManager_GameplayBattleScene"></a> GameplayBattleScene
...
### <a id="DiceRolling_Managers_GameplayTransitionManager_GameplayDungeonScene"></a> GameplayDungeonScene
...
### <a id="DiceRolling_Managers_GameplayTransitionManager_GameplayLobbyScene"></a> GameplayLobbyScene
...
### <a id="DiceRolling_Managers_GameplayTransitionManager_TransitionTo_DiceRolling_Managers_GameplayScenes_"></a> TransitionTo\(GameplayScenes\)
...
`scene` [GameplayScenes](DiceRolling.Managers.GameplayScenes.md)
