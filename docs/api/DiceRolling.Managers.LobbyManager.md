# <a id="DiceRolling_Managers_LobbyManager"></a> Class LobbyManager
...
CanvasItem ← 
Node2D ← 
[LobbyManager](DiceRolling.Managers.LobbyManager.md)
...
### <a id="DiceRolling_Managers_LobbyManager__Ready"></a> \_Ready\(\)
