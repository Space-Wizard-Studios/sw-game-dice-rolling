# <a id="DiceRolling_Managers_MenuTransitionManager"></a> Class MenuTransitionManager
...
GodotObject ← 
Node ← 
[MenuTransitionManager](DiceRolling.Managers.MenuTransitionManager.md)
...
### <a id="DiceRolling_Managers_MenuTransitionManager_GameOverMenuScene"></a> GameOverMenuScene
...
### <a id="DiceRolling_Managers_MenuTransitionManager_GameplayLobbyScene"></a> GameplayLobbyScene
...
### <a id="DiceRolling_Managers_MenuTransitionManager_MainMenuScene"></a> MainMenuScene
...
### <a id="DiceRolling_Managers_MenuTransitionManager_TransitionTo_DiceRolling_Managers_MenuScenes_"></a> TransitionTo\(MenuScenes\)
...
`scene` [MenuScenes](DiceRolling.Managers.MenuScenes.md)
