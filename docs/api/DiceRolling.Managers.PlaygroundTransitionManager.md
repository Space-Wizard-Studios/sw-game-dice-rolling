# <a id="DiceRolling_Managers_PlaygroundTransitionManager"></a> Class PlaygroundTransitionManager
...
GodotObject ← 
Node ← 
[PlaygroundTransitionManager](DiceRolling.Managers.PlaygroundTransitionManager.md)
...
### <a id="DiceRolling_Managers_PlaygroundTransitionManager_DiceGenerator"></a> DiceGenerator
...
### <a id="DiceRolling_Managers_PlaygroundTransitionManager_TransitionTo_DiceRolling_Managers_PlaygroundScenes_"></a> TransitionTo\(PlaygroundScenes\)
...
`scene` [PlaygroundScenes](DiceRolling.Managers.PlaygroundScenes.md)
