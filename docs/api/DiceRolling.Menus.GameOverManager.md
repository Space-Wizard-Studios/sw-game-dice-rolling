# <a id="DiceRolling_Menus_GameOverManager"></a> Class GameOverManager

Namespace: [DiceRolling.Menus](DiceRolling.Menus.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://features/UI/Menus/GameOverManager.cs")]
...
### <a id="DiceRolling_Menus_GameOverManager__Ready"></a> \_Ready\(\)
