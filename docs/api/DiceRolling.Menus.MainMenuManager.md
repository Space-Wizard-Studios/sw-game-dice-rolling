# <a id="DiceRolling_Menus_MainMenuManager"></a> Class MainMenuManager

Namespace: [DiceRolling.Menus](DiceRolling.Menus.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://features/UI/Menus/MainMenuManager.cs")]
...
### <a id="DiceRolling_Menus_MainMenuManager__Ready"></a> \_Ready\(\)
