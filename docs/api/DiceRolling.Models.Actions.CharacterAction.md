# <a id="DiceRolling_Models_Actions_CharacterAction"></a> Class CharacterAction
...
RefCounted ← 
Resource ← 
[CharacterAction](DiceRolling.Models.Actions.CharacterAction.md)
...
### <a id="DiceRolling_Models_Actions_CharacterAction__ctor"></a> CharacterAction\(\)

```csharp
public CharacterAction()
```

### <a id="DiceRolling_Models_Actions_CharacterAction__ctor_DiceRolling_Models_Actions_RoleAction_"></a> CharacterAction\(RoleAction\)
...
`roleAction` [RoleAction](DiceRolling.Models.Actions.RoleAction.md)

## Properties

### <a id="DiceRolling_Models_Actions_CharacterAction_Description"></a> Description
...
### <a id="DiceRolling_Models_Actions_CharacterAction_Effects"></a> Effects
...
### <a id="DiceRolling_Models_Actions_CharacterAction_Name"></a> Name
...
### <a id="DiceRolling_Models_Actions_CharacterAction_RequiredMana"></a> RequiredMana
...
### <a id="DiceRolling_Models_Actions_CharacterAction_Type"></a> Type
