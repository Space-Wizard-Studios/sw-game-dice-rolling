# <a id="DiceRolling_Models_Actions_RoleAction"></a> Class RoleAction
...
### <a id="DiceRolling_Models_Actions_RoleAction__ctor"></a> RoleAction\(\)

```csharp
public RoleAction()
```

### <a id="DiceRolling_Models_Actions_RoleAction__ctor_DiceRolling_Models_Actions_ActionType_"></a> RoleAction\(ActionType\)
...
`type` [ActionType](DiceRolling.Models.Actions.ActionType.md)

## Properties

### <a id="DiceRolling_Models_Actions_RoleAction_Type"></a> Type
