# <a id="DiceRolling_Models_Attributes_AttributeType"></a> Class AttributeType
...
### <a id="DiceRolling_Models_Attributes_AttributeType__ctor"></a> AttributeType\(\)

```csharp
public AttributeType()
```

### <a id="DiceRolling_Models_Attributes_AttributeType__ctor_System_String_System_String_Godot_Color_Godot_Texture2D_"></a> AttributeType\(string, string, Color, Texture2D\)
