# <a id="DiceRolling_Models_Attributes_CharacterAttribute"></a> Class CharacterAttribute

Namespace: [DiceRolling.Models.Attributes](DiceRolling.Models.Attributes.md)  
Assembly: dice\-rolling.dll  

```csharp
[Tool]
[GlobalClass]
[ScriptPath("res://models/Character/CharacterAttribute.cs")]
...
### <a id="DiceRolling_Models_Attributes_CharacterAttribute__ctor"></a> CharacterAttribute\(\)

```csharp
public CharacterAttribute()
```

### <a id="DiceRolling_Models_Attributes_CharacterAttribute__ctor_DiceRolling_Models_Attributes_RoleAttribute_"></a> CharacterAttribute\(RoleAttribute\)
...
`roleAttribute` [RoleAttribute](DiceRolling.Models.Attributes.RoleAttribute.md)

## Properties

### <a id="DiceRolling_Models_Attributes_CharacterAttribute_BaseValue"></a> BaseValue
...
### <a id="DiceRolling_Models_Attributes_CharacterAttribute_CurrentValue"></a> CurrentValue
...
### <a id="DiceRolling_Models_Attributes_CharacterAttribute_MaxValue"></a> MaxValue
...
### <a id="DiceRolling_Models_Attributes_CharacterAttribute_Type"></a> Type
...
### <a id="DiceRolling_Models_Attributes_CharacterAttribute__ValidateProperty_Godot_Collections_Dictionary_"></a> \_ValidateProperty\(Dictionary\)
