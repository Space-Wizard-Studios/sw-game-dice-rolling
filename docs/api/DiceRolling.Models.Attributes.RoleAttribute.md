# <a id="DiceRolling_Models_Attributes_RoleAttribute"></a> Class RoleAttribute
...
### <a id="DiceRolling_Models_Attributes_RoleAttribute__ctor"></a> RoleAttribute\(\)

```csharp
public RoleAttribute()
```

### <a id="DiceRolling_Models_Attributes_RoleAttribute__ctor_DiceRolling_Models_Attributes_AttributeType_System_Int32_"></a> RoleAttribute\(AttributeType, int\)
...
### <a id="DiceRolling_Models_Attributes_RoleAttribute_BaseValue"></a> BaseValue
...
### <a id="DiceRolling_Models_Attributes_RoleAttribute_Type"></a> Type
