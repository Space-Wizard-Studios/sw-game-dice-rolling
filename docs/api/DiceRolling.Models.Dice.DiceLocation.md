# <a id="DiceRolling_Models_Dice_DiceLocation"></a> Class DiceLocation

Namespace: [DiceRolling.Models.Dice](DiceRolling.Models.Dice.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://models/Dice/DiceLocation.cs")]
public class DiceLocation : Resource, IDisposable, IDiceLocation
```
...
### <a id="DiceRolling_Models_Dice_DiceLocation__ctor_DiceRolling_Interfaces_Dice_DiceLocationCategory_System_String_"></a> DiceLocation\(DiceLocationCategory, string?\)
...
`locationCategory` [DiceLocationCategory](DiceRolling.Interfaces.Dice.DiceLocationCategory.md)

`characterId` [string](https://learn.microsoft.com/dotnet/api/system.string)?

## Properties

### <a id="DiceRolling_Models_Dice_DiceLocation_CharacterId"></a> CharacterId
...
### <a id="DiceRolling_Models_Dice_DiceLocation_LocationCategory"></a> LocationCategory

Categoria de localização do dado.

```csharp
[Export(PropertyHint.None, "")]
public DiceLocationCategory LocationCategory { get; set; }
```
