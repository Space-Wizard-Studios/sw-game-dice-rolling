# <a id="DiceRolling_Roles_RoleAction"></a> Class RoleAction
...
### <a id="DiceRolling_Roles_RoleAction__ctor"></a> RoleAction\(\)

```csharp
public RoleAction()
```

### <a id="DiceRolling_Roles_RoleAction__ctor_DiceRolling_Actions_ActionType_"></a> RoleAction\(ActionType\)
...
`type` [ActionType](DiceRolling.Actions.ActionType.md)

## Properties

### <a id="DiceRolling_Roles_RoleAction_Type"></a> Type
