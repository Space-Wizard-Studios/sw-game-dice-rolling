# <a id="DiceRolling_Roles_RoleAttribute"></a> Class RoleAttribute
...
```csharp
[Tool]
[ScriptPath("res://features/Role/RoleAttribute.cs")]
...
### <a id="DiceRolling_Roles_RoleAttribute__ctor"></a> RoleAttribute\(\)

```csharp
public RoleAttribute()
```

### <a id="DiceRolling_Roles_RoleAttribute__ctor_DiceRolling_Attributes_AttributeType_System_Int32_"></a> RoleAttribute\(AttributeType, int\)
...
### <a id="DiceRolling_Roles_RoleAttribute_BaseValue"></a> BaseValue
...
### <a id="DiceRolling_Roles_RoleAttribute_Type"></a> Type
