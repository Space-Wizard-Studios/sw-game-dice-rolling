# <a id="DiceRolling_Stores_GameLogStore"></a> Class GameLogStore
...
GodotObject ← 
Node ← 
[GameLogStore](DiceRolling.Stores.GameLogStore.md)
...
### <a id="DiceRolling_Stores_GameLogStore_Instance"></a> Instance
...
### <a id="DiceRolling_Stores_GameLogStore_Messages"></a> Messages
...
#### Property Value
 ...
 [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[GameLogMessage](DiceRolling.Stores.GameLogMessage.md)\>

## Methods

### <a id="DiceRolling_Stores_GameLogStore_AddGameLogLine_DiceRolling_Stores_GameLogLine_"></a> AddGameLogLine\(GameLogLine\)
...
`line` [GameLogLine](DiceRolling.Stores.GameLogLine.md)

### <a id="DiceRolling_Stores_GameLogStore_AddGameLogMessage_DiceRolling_Stores_GameLogMessage_"></a> AddGameLogMessage\(GameLogMessage\)
...
`message` [GameLogMessage](DiceRolling.Stores.GameLogMessage.md)

### <a id="DiceRolling_Stores_GameLogStore_EmitSignalGameLogLineAdded"></a> EmitSignalGameLogLineAdded\(\)

```csharp
protected void EmitSignalGameLogLineAdded()
```

### <a id="DiceRolling_Stores_GameLogStore_EmitSignalGameLogUpdated"></a> EmitSignalGameLogUpdated\(\)

```csharp
protected void EmitSignalGameLogUpdated()
```

### <a id="DiceRolling_Stores_GameLogStore_GameLogLineAdded"></a> GameLogLineAdded
...
#### Event Type
 ...
 [GameLogStore](DiceRolling.Stores.GameLogStore.md).[GameLogLineAddedEventHandler](DiceRolling.Stores.GameLogStore.GameLogLineAddedEventHandler.md)

### <a id="DiceRolling_Stores_GameLogStore_GameLogUpdated"></a> GameLogUpdated
...
#### Event Type
 ...
 [GameLogStore](DiceRolling.Stores.GameLogStore.md).[GameLogUpdatedEventHandler](DiceRolling.Stores.GameLogStore.GameLogUpdatedEventHandler.md)
