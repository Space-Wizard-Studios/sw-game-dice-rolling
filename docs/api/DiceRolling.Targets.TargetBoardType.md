# <a id="DiceRolling_Targets_TargetBoardType"></a> Class TargetBoardType
...
### <a id="DiceRolling_Targets_TargetBoardType__ctor"></a> TargetBoardType\(\)
...
### <a id="DiceRolling_Targets_TargetBoardType_Grids"></a> Grids
...
### <a id="DiceRolling_Targets_TargetBoardType_IsSingleTarget"></a> IsSingleTarget
...
### <a id="DiceRolling_Targets_TargetBoardType_AddGrid_System_Int32_System_Int32_"></a> AddGrid\(int, int\)
...
### <a id="DiceRolling_Targets_TargetBoardType_EmitSignalSetupChanged"></a> EmitSignalSetupChanged\(\)

```csharp
protected void EmitSignalSetupChanged()
```

### <a id="DiceRolling_Targets_TargetBoardType_UpdateGrid_System_Int32_"></a> UpdateGrid\(int\)
...
### <a id="DiceRolling_Targets_TargetBoardType_SetupChanged"></a> SetupChanged
...
#### Event Type
 ...
 [TargetBoardType](DiceRolling.Targets.TargetBoardType.md).[SetupChangedEventHandler](DiceRolling.Targets.TargetBoardType.SetupChangedEventHandler.md)
