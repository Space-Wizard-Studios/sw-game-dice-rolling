# <a id="DiceRolling_UI_ArcDrawer"></a> Class ArcDrawer
...
CanvasItem ← 
Node2D ← 
[ArcDrawer](DiceRolling.UI.ArcDrawer.md)
...
### <a id="DiceRolling_UI_ArcDrawer_SetSelectedCharacter_DiceRolling_Components_Characters_CharacterComponent_"></a> SetSelectedCharacter\(CharacterComponent\)
...
### <a id="DiceRolling_UI_ArcDrawer__Ready"></a> \_Ready\(\)
