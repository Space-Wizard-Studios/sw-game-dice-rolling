# <a id="DiceRolling_UI_GameplayTransitionManager"></a> Class GameplayTransitionManager

Namespace: [DiceRolling.UI](DiceRolling.UI.md)  
Assembly: dice\-rolling.dll  

```csharp
[ScriptPath("res://features/UI/GameplayTransitionManager.cs")]
...
### <a id="DiceRolling_UI_GameplayTransitionManager_GameplayBattleScene"></a> GameplayBattleScene
...
### <a id="DiceRolling_UI_GameplayTransitionManager_GameplayDungeonScene"></a> GameplayDungeonScene
...
### <a id="DiceRolling_UI_GameplayTransitionManager_GameplayLobbyScene"></a> GameplayLobbyScene
...
### <a id="DiceRolling_UI_GameplayTransitionManager_TransitionTo_DiceRolling_UI_GameplayScenes_"></a> TransitionTo\(GameplayScenes\)
...
`scene` [GameplayScenes](DiceRolling.UI.GameplayScenes.md)
